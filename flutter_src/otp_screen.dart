...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future<void> _verify() async {
    ...
    try {
      ...
      final userInfo = await ApiService.getUser(widget.phoneNumber);
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('realNumber', widget.phoneNumber);
      await prefs.setString('maskedNumber', userInfo?['maskedNumber'] ?? '');
      ...
      final maskedNumber = userInfo?['maskedNumber'] ?? '';
